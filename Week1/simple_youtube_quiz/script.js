const questions=[
    ...
    {
        question:'who is the top scorer in CL??',
        answers:[
    ...
    {
        question:'How is the Netherland national tema called??',
        answers:[
            {text:'Oranje',correct:true},
            {text:'Blues',correct:false},
            {text:'Heros',correct:false},
            {text:'Eagels',correct:false},
        ]  
...
function showQuestion(){
   ...
   button.classList.add('btn')      //try -->  button.className='btn'
...
function selectAnswer(e){
    ...
    nextButton.computedStyleMap.display='block'
}
